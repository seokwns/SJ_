...
const Layout = ({ pageTitle, children }) => {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.topMenu} id='top_menu'>
                    ...
                    <a href="#" 
                        className={styles.navToggle} onClick={() => {
                            ...
                            if(toggled) {
                                ...
                                document.getElementById('chil').style.paddingTop = '200px';
                            }
                            else if (!toggled) {
                                ...
                                document.getElementById('chil').style.paddingTop = '70px';
                            }
            ...
            <main className={styles.childrenContainer} id='chil'>
                {children}
            </main>
        </div>
    )
